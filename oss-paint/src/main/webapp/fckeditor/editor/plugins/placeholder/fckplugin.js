...
FCKCommands.RegisterCommand( 'Placeholder', new FCKDialogCommand( 'Placeholder', FCKLang.DlgTemplatesTitle, FCKPlugins.Items['placeholder'].Path + 'fck_mail.html',300, 100 ) ) ;

// Create the "Plaholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'Placeholder', FCKLang.DlgTemplatesTitle ) ;
