...
%>
				<td class="<%=tdClass%>" align="<%=align%>"><a href="<%=UIToolUtils.formatUrl(UIToolUtils.formatUrl(title.getUrl(),data1.getLineData(),encode),request,form1.getReqData(),encode)%>"><%=UIToolUtils.getSubString(StringTools.valueOf(value),cellCharLength)%></a></td>
<%
			} // enf if
		} // end if
	} // end for
