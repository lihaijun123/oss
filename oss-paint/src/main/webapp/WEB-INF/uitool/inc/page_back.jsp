...
<%}%>
               ...
               转到第<input type="text" id="currPage" name="currPage" value="<%=currPage%>" size="3" maxlength="3" onkeypress="doPageKeyPress(event)">页&nbsp;共<%=total%>页；每页显示条数︰<input type="text" name="pageLimit" value="<%=maxRec%>" size="3" maxlength="3" onkeypress="doPageKeyPress(event)">
            </form>
        </td>
    </tr>
