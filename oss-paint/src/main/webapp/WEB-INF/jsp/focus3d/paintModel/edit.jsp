...
<form:form modelAttribute="paintModel" action="/paintModel.do" method="post">
	...
	<input type="hidden" name="sn" value="${paintModel.sn }" />
	<table width="100%">
		...
		<tr>
			...
			<td >
				<f:complex name="modelType" 
						   ...
						   siteType="1"
						   defaultValue="${paintModel.modelType}"
						   />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td >
				<f:complex name="houseType" 
						   ...
						   siteType="1"
						   defaultValue="${paintModel.houseType}"
						   />
		...
		<tr>
			...
			<td >
				...
				<f:fileInfo hid="modelFileSn" hname="modelFileSn" value="${paintModel.modelFileSn }"/>
			</td>
		</tr>
			</table>
	<div class="buttons">
