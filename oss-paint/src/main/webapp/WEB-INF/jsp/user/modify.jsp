		...
		<form:form modelAttribute="ossAdminUser">
			<table width="100%">
				...
				<tr>
					...
					<td align="left">
						<input type="radio" value="0" name="userLdap" id="userLdap1"
							onclick="changeUseLdap('0')" />
						否
						<input type="radio" value="1" name="userLdap" id="userLdap2"
							onclick="changeUseLdap('1')" />
						是
					</td>
				...
				<tr>
					...
					<td>
						<form:input path="password" size="40" maxlength="100"
							readonly="<%=((OssAdminUser) request.getAttribute("ossAdminUser")).isLdapUser() ? "true" : "false"%>" />
			...
			<div align="center">
				<input type="button" value=" 修 改 " id="modifySub" class="submitc" onclick="doSubmit()">
