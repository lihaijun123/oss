		...
		<form:form modelAttribute="ossAdminResource">
			<table width="100%">
				...
				<tr>
					...
					<td align="left">
						<select name="resourceType">
							<option value="1" selected="${ossAdminResource.resourceType eq 0 ? 'true' : 'false'}" >菜单</option>
						</select>
					</td>
				</tr>
				<!--
				...
				<tr>
					...
					<td align="left">
						...
						<a id="createList" lurl="/uitoolList.ui?funcID=${ossAdminResource.resourceId }" style="color: red;text-decoration: underline;">点击生成系统列表url</a>
			...
			<div class="buttons">
				...
				<input type="button" value=" 返 回 "
					...
					class="submitc">
				<c:if test="${ossAdminResource.resourceInterface ne '' }">
					<c:if test="${isExistFunc ne true }">
						<a href="/uitool.do?method=add&resourceId=${ossAdminResource.resourceId }">生成列表</a>
					</c:if>
				</c:if>
			</div>
		</form:form>
