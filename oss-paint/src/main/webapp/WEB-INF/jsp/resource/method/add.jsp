...
<html>
	...
	<body>
		<form:form modelAttribute="ossAdminResource" onsubmit="setBtn2Disabled('addSub');">
			<table width="100%">
				...
				<tr>
					<th>
						<span class="requiredredstar">*</span>方法资源名称︰
					</th>
					<td >
				...
				<tr>
					...
					<td align="left">
						<f:complex name="active" paramType="PARAM_TYPE_ACTIVE"
							...
							itemValue="parameterKey" defaultValue="1" />
					</td>
				</tr>
			</table>
			<!--form內容結束-->
			<div class="buttons">
				...
				<input type="button" value=" 返 回 "
					onclick="window.location.href='/uitoolList.ui?funcID=225'" class="submitc">
			</div>
		</form:form>
