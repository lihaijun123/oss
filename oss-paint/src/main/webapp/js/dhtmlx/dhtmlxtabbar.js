...
*   @topic: 1
*/
dhtmlXTabBar.prototype.addTab = function(id, text, size, position, row,href){    // return 0;
    row=row||0;
//#multiline:23052006{
...
//#}
    ...
    var tab=this._createTab(text, size, this._TabCloseButton, nss,href);
    tab.idd=id;
    this.tabsId[id] = tab;
...
*   @topic: 0
*/
dhtmlXTabBar.prototype._createTab = function(text,size,IsCloseButton,nss,href){
...
//#4DTabs:23052006{
            if (this._vMode)
            {
	            ...
	            //fixed by hexy 20080909
	            if(href) {
	            	thml += '<a href="'+ href +'">' + text + '</a>';
	            } else {
	            	thml += text;	
	            }
...
//#}
            {
				...
				thml+='<div style="padding-top:3px;" '+(nss[13]?('" class="'+nss[13]+'"'):'')+'>';
				//fixed by hexy 20080909
				if(href) {
	            	thml += '<a href="'+ href +'">' + text + '</a>';
	            } else {
...
//#}
   ...
   dhtmlXTabBar.prototype.setTabHref=function(href){
       this._tabHref = href;
    }; 
