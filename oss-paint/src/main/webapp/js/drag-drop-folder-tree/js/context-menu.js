...
DHTMLGoodies_menuModel.prototype = {
	 ...
	 * @param string
	 *            itemIcon = file name of menu icon(in front of menu text. Path
	 *            will be imagePath for the DHTMLSuite + file name)
	 * @param string
	 *            url = Url of menu item
	 * @param int
	 *            parent id of menu item
	 * @param String
	 *            jsFunction Name of javascript function to execute. It will
	 *            replace the url param. The function with this name will be
	 *            called and the element triggering the action will be sent as
	 *            argument. Name of the element which triggered the menu action
	 *            may also be sent as a second argument. That depends on the
	 *            widget. The context menu is an example where the element
	 *            triggering the context menu is sent as second argument to this
	 *            function.
	 *
	 * @public
	 */
...
DHTMLGoodies_contextMenu = function() {
	...
	this.imagePath = '/js/drag-drop-folder-tree/images/';
...
DHTMLGoodies_contextMenu.prototype = {
	 ...
	 * @param String
	 *            elementId = String id of element(optional). An alternative to
	 *            HTML Element
	 *
	 * @public
	 */
	 ...
	 *
	 * @param Object
	 *            context menu object = Reference to context menu object
	 *
	 * @private
	 */
